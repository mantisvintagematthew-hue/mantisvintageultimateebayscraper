...
def test_declared_overlap_too_narrow_uses_inferred_range():
    out = resolve_dates(
        {"declared_year": None, "declared_start_year": 1994, "declared_end_year": 1994, "declared_confidence": 0.5},
        {"inferred_year": 1995, "inferred_start_year": 1993, "inferred_end_year": 1997, "inferred_confidence": 0.8},
    )
    assert out["canonical_start_year"] == 1993
    assert out["canonical_end_year"] == 1997
